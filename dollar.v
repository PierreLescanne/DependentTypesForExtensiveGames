(* Time-stamp: "2016-05-06 09:12:58 pierre" *)
(****************************************************************)
(*                        dollar.v                              *)
(*                                                              *)
...
Notation "<< f >>" := (sLeaf AliceBob Choice nat f).
Notation "<< a , c , next >>" := 
  (sNode AliceBob Choice nat a c next).
Notation "[ x , y ]" := 
  (fun a:AliceBob => match a with Alice => x | Bob => y end).
Notation "<| f |>" := (gLeaf  AliceBob Choice nat f).
Notation "<| a , next |>" := (gNode AliceBob Choice nat a next).
